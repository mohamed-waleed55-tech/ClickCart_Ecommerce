...
class _PaymentApiService implements PaymentApiService {
  ...
  Future<HttpResponse<dynamic>> getAuthToken(
    Map<String, dynamic> apiKeyBody,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(apiKeyBody);
  ...
  Future<HttpResponse<dynamic>> getPaymentKey(
    Map<String, dynamic> paymentKeyBody,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(paymentKeyBody);
    final _options = _setStreamType<HttpResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
