...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T orders)?  success,TResult Function( NetworkExceptions networkExceptions)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.orders);case Failure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T orders)  success,required TResult Function( NetworkExceptions networkExceptions)  failure,}) {final _that = this;
switch (_that) {
case Success():
return success(_that.orders);case Failure():
return failure(_that.networkExceptions);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T orders)?  success,TResult? Function( NetworkExceptions networkExceptions)?  failure,}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.orders);case Failure() when failure != null:
return failure(_that.networkExceptions);case _:
...
@override
String toString() {
  return 'ResultState<$T>.success(orders: $orders)';
}
