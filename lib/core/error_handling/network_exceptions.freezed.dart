...
return unexpectedError(_that);case FirebaseAuthError() when firebaseAuthError != null:
return firebaseAuthError(_that);case FirebaseFirestoreError() when firebaseFirestoreError != null:
return firebaseFirestoreError(_that);case FirebaseDatabaseError() when firebaseDatabaseError != null:
return firebaseDatabaseError(_that);case FirebaseStorageError() when firebaseStorageError != null:
return firebaseStorageError(_that);case AgoraConnectionError() when agoraConnectionError != null:
return agoraConnectionError(_that);case AgoraTokenExpired() when agoraTokenExpired != null:
return agoraTokenExpired(_that);case _:
  return orElse();
...
return unexpectedError(_that);case FirebaseAuthError():
return firebaseAuthError(_that);case FirebaseFirestoreError():
return firebaseFirestoreError(_that);case FirebaseDatabaseError():
return firebaseDatabaseError(_that);case FirebaseStorageError():
return firebaseStorageError(_that);case AgoraConnectionError():
return agoraConnectionError(_that);case AgoraTokenExpired():
return agoraTokenExpired(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  requestCancelled,TResult Function( String reason)?  unauthorizedRequest,TResult Function()?  badRequest,TResult Function( String reason)?  notFound,TResult Function()?  methodNotAllowed,TResult Function()?  notAcceptable,TResult Function()?  requestTimeout,TResult Function()?  sendTimeout,TResult Function( String reason)?  unprocessableEntity,TResult Function()?  conflict,TResult Function()?  internalServerError,TResult Function()?  notImplemented,TResult Function()?  serviceUnavailable,TResult Function()?  noInternetConnection,TResult Function()?  formatException,TResult Function()?  unableToProcess,TResult Function( String error)?  defaultError,TResult Function()?  unexpectedError,TResult Function( String message)?  firebaseAuthError,TResult Function( String message)?  firebaseFirestoreError,TResult Function( String message)?  firebaseDatabaseError,TResult Function( String message)?  firebaseStorageError,TResult Function( String message)?  agoraConnectionError,TResult Function()?  agoraTokenExpired,required TResult orElse(),}) {final _that = this;
switch (_that) {
case RequestCancelled() when requestCancelled != null:
...
return unexpectedError();case FirebaseAuthError() when firebaseAuthError != null:
return firebaseAuthError(_that.message);case FirebaseFirestoreError() when firebaseFirestoreError != null:
return firebaseFirestoreError(_that.message);case FirebaseDatabaseError() when firebaseDatabaseError != null:
return firebaseDatabaseError(_that.message);case FirebaseStorageError() when firebaseStorageError != null:
return firebaseStorageError(_that.message);case AgoraConnectionError() when agoraConnectionError != null:
return agoraConnectionError(_that.message);case AgoraTokenExpired() when agoraTokenExpired != null:
return agoraTokenExpired();case _:
  return orElse();
...
return unexpectedError();case FirebaseAuthError():
return firebaseAuthError(_that.message);case FirebaseFirestoreError():
return firebaseFirestoreError(_that.message);case FirebaseDatabaseError():
return firebaseDatabaseError(_that.message);case FirebaseStorageError():
return firebaseStorageError(_that.message);case AgoraConnectionError():
return agoraConnectionError(_that.message);case AgoraTokenExpired():
return agoraTokenExpired();case _:
  throw StateError('Unexpected subclass');
...
class FirebaseAuthError implements NetworkExceptions {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FirebaseAuthErrorCopyWith<FirebaseAuthError> get copyWith => _$FirebaseAuthErrorCopyWithImpl<FirebaseAuthError>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FirebaseAuthError&&(identical(other.message, message) || other.message == message));
}
...
@override
String toString() {
  return 'NetworkExceptions.firebaseAuthError(message: $message)';
}
...
/// @nodoc
abstract mixin class $FirebaseAuthErrorCopyWith<$Res> implements $NetworkExceptionsCopyWith<$Res> {
  factory $FirebaseAuthErrorCopyWith(FirebaseAuthError value, $Res Function(FirebaseAuthError) _then) = _$FirebaseAuthErrorCopyWithImpl;
@useResult
$Res call({
 String message
});
...
class _$FirebaseAuthErrorCopyWithImpl<$Res>
  ...
  _$FirebaseAuthErrorCopyWithImpl(this._self, this._then);

  final FirebaseAuthError _self;
  final $Res Function(FirebaseAuthError) _then;
...
class FirebaseFirestoreError implements NetworkExceptions {
  const FirebaseFirestoreError(this.message);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FirebaseFirestoreErrorCopyWith<FirebaseFirestoreError> get copyWith => _$FirebaseFirestoreErrorCopyWithImpl<FirebaseFirestoreError>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FirebaseFirestoreError&&(identical(other.message, message) || other.message == message));
}
...
@override
String toString() {
  return 'NetworkExceptions.firebaseFirestoreError(message: $message)';
}
...
/// @nodoc
abstract mixin class $FirebaseFirestoreErrorCopyWith<$Res> implements $NetworkExceptionsCopyWith<$Res> {
  factory $FirebaseFirestoreErrorCopyWith(FirebaseFirestoreError value, $Res Function(FirebaseFirestoreError) _then) = _$FirebaseFirestoreErrorCopyWithImpl;
@useResult
$Res call({
 String message
});
...
/// @nodoc
class _$FirebaseFirestoreErrorCopyWithImpl<$Res>
    implements $FirebaseFirestoreErrorCopyWith<$Res> {
  _$FirebaseFirestoreErrorCopyWithImpl(this._self, this._then);

  final FirebaseFirestoreError _self;
  final $Res Function(FirebaseFirestoreError) _then;

/// Create a copy of NetworkExceptions
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? message = null,}) {
  return _then(FirebaseFirestoreError(
null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class FirebaseDatabaseError implements NetworkExceptions {
  const FirebaseDatabaseError(this.message);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FirebaseDatabaseErrorCopyWith<FirebaseDatabaseError> get copyWith => _$FirebaseDatabaseErrorCopyWithImpl<FirebaseDatabaseError>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FirebaseDatabaseError&&(identical(other.message, message) || other.message == message));
}
...
@override
String toString() {
  return 'NetworkExceptions.firebaseDatabaseError(message: $message)';
}
...
/// @nodoc
abstract mixin class $FirebaseDatabaseErrorCopyWith<$Res> implements $NetworkExceptionsCopyWith<$Res> {
  factory $FirebaseDatabaseErrorCopyWith(FirebaseDatabaseError value, $Res Function(FirebaseDatabaseError) _then) = _$FirebaseDatabaseErrorCopyWithImpl;
@useResult
$Res call({
 String message
});
...
/// @nodoc
class _$FirebaseDatabaseErrorCopyWithImpl<$Res>
    implements $FirebaseDatabaseErrorCopyWith<$Res> {
  _$FirebaseDatabaseErrorCopyWithImpl(this._self, this._then);

  final FirebaseDatabaseError _self;
  final $Res Function(FirebaseDatabaseError) _then;

/// Create a copy of NetworkExceptions
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? message = null,}) {
  return _then(FirebaseDatabaseError(
null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class FirebaseStorageError implements NetworkExceptions {
  const FirebaseStorageError(this.message);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FirebaseStorageErrorCopyWith<FirebaseStorageError> get copyWith => _$FirebaseStorageErrorCopyWithImpl<FirebaseStorageError>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FirebaseStorageError&&(identical(other.message, message) || other.message == message));
}
...
@override
String toString() {
  return 'NetworkExceptions.firebaseStorageError(message: $message)';
}
...
/// @nodoc
abstract mixin class $FirebaseStorageErrorCopyWith<$Res> implements $NetworkExceptionsCopyWith<$Res> {
  factory $FirebaseStorageErrorCopyWith(FirebaseStorageError value, $Res Function(FirebaseStorageError) _then) = _$FirebaseStorageErrorCopyWithImpl;
@useResult
$Res call({
 String message
});
...
/// @nodoc
class _$FirebaseStorageErrorCopyWithImpl<$Res>
    implements $FirebaseStorageErrorCopyWith<$Res> {
  _$FirebaseStorageErrorCopyWithImpl(this._self, this._then);

  final FirebaseStorageError _self;
  final $Res Function(FirebaseStorageError) _then;

/// Create a copy of NetworkExceptions
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? message = null,}) {
  return _then(FirebaseStorageError(
null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class AgoraConnectionError implements NetworkExceptions {
  const AgoraConnectionError(this.message);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AgoraConnectionErrorCopyWith<AgoraConnectionError> get copyWith => _$AgoraConnectionErrorCopyWithImpl<AgoraConnectionError>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AgoraConnectionError&&(identical(other.message, message) || other.message == message));
}
...
@override
String toString() {
  return 'NetworkExceptions.agoraConnectionError(message: $message)';
}
...
/// @nodoc
abstract mixin class $AgoraConnectionErrorCopyWith<$Res> implements $NetworkExceptionsCopyWith<$Res> {
  factory $AgoraConnectionErrorCopyWith(AgoraConnectionError value, $Res Function(AgoraConnectionError) _then) = _$AgoraConnectionErrorCopyWithImpl;
@useResult
$Res call({
 String message
});
...
/// @nodoc
class _$AgoraConnectionErrorCopyWithImpl<$Res>
    implements $AgoraConnectionErrorCopyWith<$Res> {
  _$AgoraConnectionErrorCopyWithImpl(this._self, this._then);

  final AgoraConnectionError _self;
  final $Res Function(AgoraConnectionError) _then;

/// Create a copy of NetworkExceptions
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? message = null,}) {
  return _then(AgoraConnectionError(
null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class AgoraTokenExpired implements NetworkExceptions {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AgoraTokenExpired);
}
...
@override
String toString() {
  return 'NetworkExceptions.agoraTokenExpired()';
}
