...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FirestoreResult<T>);
}
...
/// @nodoc
class $FirestoreResultCopyWith<T,$Res>  {
$FirestoreResultCopyWith(FirestoreResult<T> _, $Res Function(FirestoreResult<T>) __);
}


/// Adds pattern-matching-related methods to [FirestoreResult].
extension FirestoreResultPatterns<T> on FirestoreResult<T> {
...
class Success<T> implements FirestoreResult<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of FirestoreResult
...
@override
String toString() {
  return 'FirestoreResult<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $FirestoreResultCopyWith<T, $Res> {
...
class Failure<T> implements FirestoreResult<T> {
...
@override
String toString() {
  return 'FirestoreResult<$T>.failure(error: $error)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $FirestoreResultCopyWith<T, $Res> {
