...
class _ProductsApi implements ProductsApi {
  ...
  @override
  Future<ApiResponse> getProductsFromApi() async {
    ...
    try {
      _value = await compute(deserializeApiResponse, _result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<ApiResponse> getProductsByCategory(String slug) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
